    ...
    <div className='login-container'>
      ...
      <div className='login-left-container'>
        ...
        <form>
          ...
          <span style={{marginLeft:'5rem'}}>Don’t have an account? <button style={{background:'none', color:'black', fontSize:'medium'}} onClick={()=>{navigate('/register')}}>Sign Up</button></span>
        </form>
      </div>
